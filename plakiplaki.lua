...
local Library = {
    ...
    Colors = {
        Window = Color3.fromRGB(20, 20, 20),        -- Темно-серый фон
    BorderColor = Color3.fromRGB(30, 30, 30),    -- Немного светлее границы
    Accent = Color3.fromRGB(100, 50, 150),       -- Темный фиолетовый, смешанный с синим и красным
    TopBar = Color3.fromRGB(30, 30, 30),          -- Темный фон верхней панели
    TopText = Color3.fromRGB(200, 200, 255),      -- Светлый голубой для текста
    TabContainer = Color3.fromRGB(20, 20, 20),    -- Тот же темный фон для контейнера табов
    TabActive = Color3.fromRGB(180, 0, 150),      -- Яркий розовый для активного таба
    TabInactive = Color3.fromRGB(100, 0, 80),     -- Тёмный розовый для неактивного таба
    ContentContainer = Color3.fromRGB(20, 20, 20), -- Тот же темный фон для контейнера содержимого
    Section = Color3.fromRGB(30, 30, 30),         -- Тот же темный фон для секций
    SectionText = Color3.fromRGB(200, 150, 250),  -- Светло-фиолетовый для текста секций
    RiskyActive = Color3.fromRGB(255, 60, 60),    -- Ярко-красный для активных рисковых элементов
    RiskyInactive = Color3.fromRGB(150, 30, 30),  -- Тёмно-красный для неактивных рисковых элементов
    ElementActive = Color3.fromRGB(100, 100, 255), -- Светло-синий для активных элементов
    ElementInactive = Color3.fromRGB(50, 50, 150)  -- Тёмно-синий для неактивных элементов
    },
    Instances = {},
    Connections = {},
    Font = nil,
